...
- **components:** Post publish date should be displayed only after hydration ([2a28386](https://github.com/TenkoSpirit/genshin.zenless.club/commit/2a28386058f31b8affed3bcdfeaea5cd95861393))
- **components:** `Navbar` logout button didn't do anything ([648d37b](https://github.com/TenkoSpirit/genshin.zenless.club/commit/648d37b446d63ff76cd95549bb6b7a05c0892caf))
- **css:** Markdown styles are somewhat unaware of tailwind ([9f1af8e](https://github.com/TenkoSpirit/genshin.zenless.club/commit/9f1af8e17f3e30caa648990f8b11ed2f2465c357))
- **markdown:** Added `Root` type to the custom plugin ([339b801](https://github.com/TenkoSpirit/genshin.zenless.club/commit/339b80143fcd408d3c5540cff5db59f47a80aece))
- **npm:** Added resolution for vulnerable package ([aa5e329](https://github.com/TenkoSpirit/genshin.zenless.club/commit/aa5e3298a3a25afcad410c6a3be279f14be11d26))
- **root:** Import `RouteHandle` type ([43b187f](https://github.com/TenkoSpirit/genshin.zenless.club/commit/43b187f05c024fb1f7e79fe4245156f3ea73f5cf))
- **root:** Logout button now actually works ([5e808f0](https://github.com/TenkoSpirit/genshin.zenless.club/commit/5e808f08a1f09ecc324d87ba43186659a44cddc6))
- **rotues:** Display publish date of the post after it's hydrated ([7f50a88](https://github.com/TenkoSpirit/genshin.zenless.club/commit/7f50a88927cda8f5283590bec7affcc57212ca13))
- **routes:** Incorrect error on nonexistent character ([784e99d](https://github.com/TenkoSpirit/genshin.zenless.club/commit/784e99dc63dca0a3c755466866c4fb4b8f7a72d4))
- **routes:** Meta function's data may be undefined ([117f7b3](https://github.com/TenkoSpirit/genshin.zenless.club/commit/117f7b3c7424fe5b18b7b86b311f9a62df000263))
- **routes:** Incorrect permission flag was used for authorization check ([06a05ca](https://github.com/TenkoSpirit/genshin.zenless.club/commit/06a05cac18af1ef6906bf0c886e99ca74b0fd56f))
- **routes:** Incorrect permission check on post deletion ([d6e31be](https://github.com/TenkoSpirit/genshin.zenless.club/commit/d6e31bef02f7de9e55f31940ab9dbf79b373a534))
- **utils:** Incorrect type for `user` param in `canUserDeletePost` ([d8a661b](https://github.com/TenkoSpirit/genshin.zenless.club/commit/d8a661b09a9ec0826bf104f0f04d089caf8c8766))
- **utils:** Updated `safePickLocale` param type ([ae42925](https://github.com/TenkoSpirit/genshin.zenless.club/commit/ae42925033b06edd3b365dce6efd25d8c1a03356))
- **utils/s3:** Return proper url of the uploaded file ([d6562ea](https://github.com/TenkoSpirit/genshin.zenless.club/commit/d6562eaf4a14a7cf899d9ef2d0ef20a15c62d491))

### Features

- **README:** New domain ([5249c70](https://github.com/TenkoSpirit/genshin.zenless.club/commit/5249c70717edeff94f370d7e1e618e68b640a393))
- **atoms:** Created `colorSchemeAtom` ([7c441f3](https://github.com/TenkoSpirit/genshin.zenless.club/commit/7c441f3925c8a1e28170eed838dd0a13cb871240))
- **atoms:** Added a derived `colorSchemeAtom` with a type guarded setter ([1aa39f6](https://github.com/TenkoSpirit/genshin.zenless.club/commit/1aa39f6fd27fac573db988616bf846516267dc42))
- **components:** Added `withScrollRestoration` to `Container` so scroll restoration could be used where needed ([3d05d0a](https://github.com/TenkoSpirit/genshin.zenless.club/commit/3d05d0a6122be82ecb3d46dd927e197a06131b31))
- **components:** Get rid of dates on psot cards for sake of testing for react minified errors ([b6a66d1](https://github.com/TenkoSpirit/genshin.zenless.club/commit/b6a66d1a47c1515bcc6ba5e6d2035ac39abdc686))
- **components:** Created `UserFlair` which displays flairs obviously ([e739a89](https://github.com/TenkoSpirit/genshin.zenless.club/commit/e739a89e9fec81ac9ea803fa2a6f6689f9bb92ad))
- **components:** Deleted `RoleBadge` in favor of flairs ([17d241c](https://github.com/TenkoSpirit/genshin.zenless.club/commit/17d241c7bbc2419f0ad6a7ca0641762bf77ed7fb))
- **components:** Replace header with navbar (nased on tailwind example) ([2305ae8](https://github.com/TenkoSpirit/genshin.zenless.club/commit/2305ae8b422eb1842016700a74311c0fad9f23b9))
- **components:** Dark styling for a `PostCard` ([9f413d6](https://github.com/TenkoSpirit/genshin.zenless.club/commit/9f413d6bf5e5192e47e16a741b3cd4c587dbe306))
- **components:** Added dark variation to `CalculatorInput` ([7c1835d](https://github.com/TenkoSpirit/genshin.zenless.club/commit/7c1835dea8e86bd8ba0f9eb5d09007bc467e5950))
- **components:** Supporting dark scheme on `Footer` ([88a6cd6](https://github.com/TenkoSpirit/genshin.zenless.club/commit/88a6cd67ae13846606ec7f12989d814d69454afc))
- **components:** Created polymorphic `Paper` ([7d61d83](https://github.com/TenkoSpirit/genshin.zenless.club/commit/7d61d836cea703a9daa10e858b2f4730bc2d2d23))
- **components:** Use `Paper` as base of `PostCard` ([ced71fe](https://github.com/TenkoSpirit/genshin.zenless.club/commit/ced71fe9ddc686526f4e2fd94227ec5aeb0f74e6))
- **components:** Use `Paper` in `CharacterCard` ([5940354](https://github.com/TenkoSpirit/genshin.zenless.club/commit/594035431270b3a0eb8ad28c309e4eaa9f52d735))
- **components:** Use `Paper` in `BirthdayCard` ([5e02b30](https://github.com/TenkoSpirit/genshin.zenless.club/commit/5e02b306d4547260fe82aef2bfce055c2fddcd83))
- **components:** Created `Checkbox` ([977a5e1](https://github.com/TenkoSpirit/genshin.zenless.club/commit/977a5e1e4741b620e391be77fa0d5e60ca7c2d2e))
- **components:** Added files manager url to user navigation ([0bb1022](https://github.com/TenkoSpirit/genshin.zenless.club/commit/0bb1022c423f02adfdd1b798fe0a5fa8305f1b61))
- **components:** Updated `Navbar` with fresh styles ([ecfdf04](https://github.com/TenkoSpirit/genshin.zenless.club/commit/ecfdf047fe7a7954745d174f0895f551b0fc54cb))
- **components:** Added `OverviewIcon` ([937c0f7](https://github.com/TenkoSpirit/genshin.zenless.club/commit/937c0f7b66462f6ec1a23af8c4a040217465d451))
- **components:** Added `Rarity` which renders stars as rarity ([b3fec62](https://github.com/TenkoSpirit/genshin.zenless.club/commit/b3fec6251c9375972d107a11bd6b4564b96d0509))
- **components, routes:** Apply newer styles ([147bd54](https://github.com/TenkoSpirit/genshin.zenless.club/commit/147bd54e1ad173030f63b1d14f2bd8c5f014cfb7))
- **css:** Incresed max width for content ([4ee33ef](https://github.com/TenkoSpirit/genshin.zenless.club/commit/4ee33ef71c91b744e00a0e9d80994dca0e9639c5))
- **css:** Added tailwind layer to markdown styles and added support for dark color scheme ([75c33c9](https://github.com/TenkoSpirit/genshin.zenless.club/commit/75c33c96cd5dfb7101b0b3a3fae24d144e37e29e))
- **css:** Set progress bar color to blau ([4385668](https://github.com/TenkoSpirit/genshin.zenless.club/commit/4385668b16a82e548b65b2c682628412cba2cf88))
- **css:** Added styling for dark color scheme ([91e8eab](https://github.com/TenkoSpirit/genshin.zenless.club/commit/91e8eab61d6bfef3fbdc3bf58c1daf87f65833bd))
- **css:** Moved paper classes to a css class ([3a45e84](https://github.com/TenkoSpirit/genshin.zenless.club/commit/3a45e84a6d687de22f95d79c64d74cc9e370fe4e))
- **css:** Added checkbox base styles ([be9d34b](https://github.com/TenkoSpirit/genshin.zenless.club/commit/be9d34b0a8916f31c76df15d228eb5c401a8ce54))
- **css:** Added focus-visible to button ([e510380](https://github.com/TenkoSpirit/genshin.zenless.club/commit/e510380aecea6ad9eca66c46e1c346a0653ae0f1))
- **css:** Updated styles with open color ([f3f4028](https://github.com/TenkoSpirit/genshin.zenless.club/commit/f3f4028ab497b0d516dbd0236e34ac8fbf94a0db))
- **css:** Buttons are gray by default ([bd75c80](https://github.com/TenkoSpirit/genshin.zenless.club/commit/bd75c8051eac84ca855aaf1dd79ff6f14e3f1f64))
- **css:** Custom scrollbar ([00aee3e](https://github.com/TenkoSpirit/genshin.zenless.club/commit/00aee3e1227989276b9e17cbda449aa2b8fefe5c))
- **db, oauth:** Using `requiredServerEnv` ([78851b6](https://github.com/TenkoSpirit/genshin.zenless.club/commit/78851b670c7e859497b490f529409a3faea57746))
- **deps:** Added `clsx` ([2b3abd2](https://github.com/TenkoSpirit/genshin.zenless.club/commit/2b3abd211c31889439cbbfbee6129b1798ee932c))
- **entry, root, utils:** Inject Tailwind CSS right into the markup ([5b3428c](https://github.com/TenkoSpirit/genshin.zenless.club/commit/5b3428cf3d7ec6491c0aff8b78a30c7552c1d070))
- **env:** Added more env varaibles ([ef5dd5c](https://github.com/TenkoSpirit/genshin.zenless.club/commit/ef5dd5c6beaf267d665b4c2232c8cdf78ecd43f8))
- **env:** Updated variables ([b13a6af](https://github.com/TenkoSpirit/genshin.zenless.club/commit/b13a6af65736324e5eb7d8b4f78846116dc6b02f))
- **hooks:** Added `useHydrated` and `useAfterHydration` ([6ab779e](https://github.com/TenkoSpirit/genshin.zenless.club/commit/6ab779ea8ae7fca1110ded84ea36c53537bce3e9))
- **i18n:** Added strings for post authors ([8ee795f](https://github.com/TenkoSpirit/genshin.zenless.club/commit/8ee795f5879d7e0e5148c8c0e7154c56a77bdd39))
- **i18n:** Added translation string ([9b02c74](https://github.com/TenkoSpirit/genshin.zenless.club/commit/9b02c7422d0fbcee751ff5d6c77c174c9a77fa83))
- **i18n:** More strings ([82b2c51](https://github.com/TenkoSpirit/genshin.zenless.club/commit/82b2c517cb48d45eac3ce7609504b10408a850c2))
- **lib:** Re-export `zod` to make sure it's server only ([3171e65](https://github.com/TenkoSpirit/genshin.zenless.club/commit/3171e65620869914b1429c4025d874927f97b232))
- **lib:** Re-exported sharp as server only ([356e7d3](https://github.com/TenkoSpirit/genshin.zenless.club/commit/356e7d3a466cdaa0e0df67b45a621ed60ab5b496))
- **lib:** Re-exported `nanoid` with default config ([dd00022](https://github.com/TenkoSpirit/genshin.zenless.club/commit/dd0002214c7a5947ec9c4c2bab3a3fe0045e4180))
- **lib:** Created `sha256HexFromBuffer` function ([ff33a39](https://github.com/TenkoSpirit/genshin.zenless.club/commit/ff33a397ff8f04e643655a3cf592db0992ff96b3))
- **models:** Added functions to work with linked accounts of users ([e8b5126](https://github.com/TenkoSpirit/genshin.zenless.club/commit/e8b5126323ec513adaf2df59afc7bf170e8bd7c1))
- **models:** Added roles management functions to user ([9d7a98c](https://github.com/TenkoSpirit/genshin.zenless.club/commit/9d7a98c6f2e2da123813ba77f5d8731da642bc68))
- **models:** Gotta include flair and permissions with user requests ([6272db1](https://github.com/TenkoSpirit/genshin.zenless.club/commit/6272db15538e4d94438c82c1b0cb8c0781397cb3))
- **models:** Include posts authors flairs ([281da5d](https://github.com/TenkoSpirit/genshin.zenless.club/commit/281da5dab358ee3c4f6ac66fa8f4ae6afbfa0b95))
- **models:** Include assets with character and modified `getCharacterById` ([f81716f](https://github.com/TenkoSpirit/genshin.zenless.club/commit/f81716f9b749341f9d968e812fce764c9ff5106b))
- **npm:** Always use minified tailwind styles ([6c7d127](https://github.com/TenkoSpirit/genshin.zenless.club/commit/6c7d1277eb4c532a7ec3cf310438236c3f3dff20))
- **npm:** PostCSS build will be verbose now ([531be97](https://github.com/TenkoSpirit/genshin.zenless.club/commit/531be977ee866c35cd6fb99ecea1b0666f60094f))
- **preisma:** A new model to store S3 data ([a339791](https://github.com/TenkoSpirit/genshin.zenless.club/commit/a339791763ff189213f628f8e07629f213127698))
- **prisma:** Created `LinkedAccounts` model to store OAuth linked accounts of users ([5d422bb](https://github.com/TenkoSpirit/genshin.zenless.club/commit/5d422bb1966d3c5bade52d33662e28766dbc81d4))
- **prisma:** Added permissions and flairs to db ([9db30b1](https://github.com/TenkoSpirit/genshin.zenless.club/commit/9db30b113be98b8e677fc67a5027e467d55f56d4))
- **prisma:** Add separate colors for bg and fg on flairs ([f66dcf4](https://github.com/TenkoSpirit/genshin.zenless.club/commit/f66dcf49b91958fdfbc25e176328e45b59da8081))
- **prisma:** Added permission flags for assets management ([24aa257](https://github.com/TenkoSpirit/genshin.zenless.club/commit/24aa257bdf33ced65684213720bdb5250fd31546))
- **prisma:** Removed asset model ([5d97cdf](https://github.com/TenkoSpirit/genshin.zenless.club/commit/5d97cdf0721db652fc77d738867f64cc95cb62c0))
- **prisma:** Added a model to store character assets ([d231fe2](https://github.com/TenkoSpirit/genshin.zenless.club/commit/d231fe2c9ceebbc1b1f002b538ecf4bff50c1d84))
- **prisma:** Added `File` and `FileTag` models ([4dc7f91](https://github.com/TenkoSpirit/genshin.zenless.club/commit/4dc7f913cb898badeeb0f62d29d02f93c6020155))
- **prisma:** Added one more permission flag and update `File` model ([cc68717](https://github.com/TenkoSpirit/genshin.zenless.club/commit/cc6871775c1d311abc8ca5c06cb4c2cd0a73ebe6))
- **prisma:** Store SHA256 checksums to prevent reupload ([d75a25a](https://github.com/TenkoSpirit/genshin.zenless.club/commit/d75a25ad5b3359017c95f3986ea79117c3803c48))
- **responses:** Added `TypedJsonError` type which could be used later ([8498ee3](https://github.com/TenkoSpirit/genshin.zenless.club/commit/8498ee3dca81ae8b9ceb81fa4924635495fb5794))
- **root:** Added `handle` ([84fc69d](https://github.com/TenkoSpirit/genshin.zenless.club/commit/84fc69dbdafae5a15ea8b26842f3f9afae5f0943))
- **root:** Added `antialiased` to body ([468d926](https://github.com/TenkoSpirit/genshin.zenless.club/commit/468d9264df4880835f4f42789bebb358e5e21857))
- **root:** Updated root catch boundary so it's consistent with predefined responses ([2687bcf](https://github.com/TenkoSpirit/genshin.zenless.club/commit/2687bcf14ad6f1333de2203df61fd26bebd76af0))
- **root:** Providing jotai atoms with initial values from the server and handling dark theme ([616350e](https://github.com/TenkoSpirit/genshin.zenless.club/commit/616350e75eac8ef80a6e0904017c1366100496d6))
- **root:** Inter css file is now included ([e6a1a47](https://github.com/TenkoSpirit/genshin.zenless.club/commit/e6a1a471f6604bf1d13b9b4ac8ca94e93746ccc6))
- **root:** Replaced `Header` with `Navbar` ([a5be5b4](https://github.com/TenkoSpirit/genshin.zenless.club/commit/a5be5b430b2db3bae482ba66bca26ac8145720d3))
- **root:** Preload font css ([d3508f7](https://github.com/TenkoSpirit/genshin.zenless.club/commit/d3508f70b12f88c76144a74acf2b6041b5be34e3))
- **root, client:** Moved `Jotai`'s provider into `root` and adjusted the root code so it uses `clsx` for detemining if css transitions are enabled or not ([3afc656](https://github.com/TenkoSpirit/genshin.zenless.club/commit/3afc656fcb07a50a94147bc3c78bfd4bb0056450))
- **root, components:** Use or not use `ScrollRestoration` based on route's handle ([9458a63](https://github.com/TenkoSpirit/genshin.zenless.club/commit/9458a6360b2d9c0684317b74a93583dd9a402590))
- **routes:** Added a discord oauth callback route for accounts linking ([97e45c3](https://github.com/TenkoSpirit/genshin.zenless.club/commit/97e45c39166fa082588568afbedf79908bae4d42))
- **routes:** Added discord oauth callback route for logging in ([b7731ac](https://github.com/TenkoSpirit/genshin.zenless.club/commit/b7731ac669f1683c7a005ac158eb7dbd83216690))
- **routes:** Added discord login button and moved the file ([236e283](https://github.com/TenkoSpirit/genshin.zenless.club/commit/236e2833424687aef43005b4a03042368c628291))
- **routes:** Added a list of linked accounts and a way to link a discord account ([ced0f8a](https://github.com/TenkoSpirit/genshin.zenless.club/commit/ced0f8a0ebbcdf4c8bbb1ade5f5bf7891ad8ccf2))
- **routes:** Added raw markdown view of a post to authorized users ([c3414ff](https://github.com/TenkoSpirit/genshin.zenless.club/commit/c3414ffabcfdd15f1d94872a1a26fc36eea6de0a))
- **routes:** Added `handle`s to the existing pages ([2cba637](https://github.com/TenkoSpirit/genshin.zenless.club/commit/2cba637d978877a5fc364b96148c3e52d79fe5b2))
- **routes:** Added roles control to user management and utilizing nested layouts ([9cc084a](https://github.com/TenkoSpirit/genshin.zenless.club/commit/9cc084ad381ac3d6d104c823ad440e70302be687))
- **routes:** Changed the looks of a post page, might be looking prettier now ([64e96fd](https://github.com/TenkoSpirit/genshin.zenless.club/commit/64e96fd6f34a7b7734e98039856ed9066bfa3e9b))
- **routes:** Added post authors ([304a0c5](https://github.com/TenkoSpirit/genshin.zenless.club/commit/304a0c5f1baebf1f73c97df5d14de9d5ad8085f8))
- **routes:** Smaller gap between post title and thumbnail ([39618cf](https://github.com/TenkoSpirit/genshin.zenless.club/commit/39618cf924a96e42dada361b7253fb4d7f93667c))
- **routes:** User cards on yashito now lead to overview ([cd8adcf](https://github.com/TenkoSpirit/genshin.zenless.club/commit/cd8adcfa92220b6ce2284276c1d92c48acbb4f55))
- **routes:** Updated user edit page with permission flags and removed roles ([5672eca](https://github.com/TenkoSpirit/genshin.zenless.club/commit/5672eca5786643e753a5b9e9e7682b40260123fd))
- **routes:** Updated loader authorization check for yashiro home ([fcd15ad](https://github.com/TenkoSpirit/genshin.zenless.club/commit/fcd15ad9735b700297ec748ffc2d6be0da0275db))
- **routes:** Support fgColro and bgColor on yashiro edit page ([be8f918](https://github.com/TenkoSpirit/genshin.zenless.club/commit/be8f918cc9dfa668019e50830c591f1247fcba1d))
- **routes:** Removed roles and added a flair to `/me` ([61c999c](https://github.com/TenkoSpirit/genshin.zenless.club/commit/61c999cc1f3ba5d129d7dc8898b806dabc61848d))
- **routes:** Display flair of a post author in footer ([af98505](https://github.com/TenkoSpirit/genshin.zenless.club/commit/af985056e9721d46c71236588613f970c8af8a17))
- **routes:** Updated authorization check for posts creation route ([5d45e46](https://github.com/TenkoSpirit/genshin.zenless.club/commit/5d45e46b7127dcc83fc2496b2c1537696427d474))
- **routes:** Updated authorization check for raw post ([361ef25](https://github.com/TenkoSpirit/genshin.zenless.club/commit/361ef2595871e657b0706e8552899421e074305e))
- **routes:** Use permission flag check for yashiro page ([0c34aa6](https://github.com/TenkoSpirit/genshin.zenless.club/commit/0c34aa6c5c7832ebdda37d10c5dccf2c4a366934))
- **routes:** Utilizing `validateUserPermissions` on protected routes ([a52db9d](https://github.com/TenkoSpirit/genshin.zenless.club/commit/a52db9d7fc45e34001e7897192bc6ace1cecf368))
- **routes:** Simplified a check for value if it's a `PermissionFlag` or not ([666efa9](https://github.com/TenkoSpirit/genshin.zenless.club/commit/666efa92c23f7c4dcafad5b5242415fc017d362e))
- **routes:** Post's thumbnail is anow async and lazy ([2b9908a](https://github.com/TenkoSpirit/genshin.zenless.club/commit/2b9908aa7277836ec38d45e96d8db0d7e3f91055))
- **routes:** Updated `/posts/` routes with predefined responses ([27737df](https://github.com/TenkoSpirit/genshin.zenless.club/commit/27737dfd2c22de09ca0e262841cd83ee1f36c1f8))
- **routes:** Updated `/set-locale` with predefined responses ([b835994](https://github.com/TenkoSpirit/genshin.zenless.club/commit/b8359943c86adddb05e9ab1c9e0c9e2cef189ef7))
- **routes:** Updated `/posts/$slug/raw` with predefined responses ([ecc4201](https://github.com/TenkoSpirit/genshin.zenless.club/commit/ecc42012c3d45eaf924bb7623124fe973b6b4080))
- **routes:** Updated linking with Discord OAuth callback with predefined responses ([7f79b61](https://github.com/TenkoSpirit/genshin.zenless.club/commit/7f79b6156a6f909f951221ae166e02b64af3db07))
- **routes:** Updated login with Discord with predefined responses ([74bf75f](https://github.com/TenkoSpirit/genshin.zenless.club/commit/74bf75fdc46952de3b915f1dff124aad7c0f574c))
- **routes:** Updated thrown responses with predefined ones on `/characters/$id` ([bc0fddf](https://github.com/TenkoSpirit/genshin.zenless.club/commit/bc0fddf3f428462e63fd40cc50674d9614d753b0))
- **routes:** Created a page that is being displayed for disabled accounts ([7540133](https://github.com/TenkoSpirit/genshin.zenless.club/commit/7540133705fc403f7bf199dd9765a5e7d036ee07))
- **routes:** Added a route which returns a cookie with color scheme ([b5dc501](https://github.com/TenkoSpirit/genshin.zenless.club/commit/b5dc50164231275bb9c3509b7b5cd7e2e98ae069))
- **routes:** Remove markdown css link since markdown styles are now included in main ([0b97d34](https://github.com/TenkoSpirit/genshin.zenless.club/commit/0b97d348fa6ba5f350a48e68ba63e260616fc28c))
- **routes:** Added dark styles to posts ([18948b8](https://github.com/TenkoSpirit/genshin.zenless.club/commit/18948b8f49a5b5ead6fb5ebe5bf659e372d8f1a9))
- **routes:** Dark styles for posts search page ([9494b81](https://github.com/TenkoSpirit/genshin.zenless.club/commit/9494b812dbd8e08dd55dedce46fd165ee8f1774d))
- **routes:** Added color scheme setting ([5e6956b](https://github.com/TenkoSpirit/genshin.zenless.club/commit/5e6956bdd6584a0ad4b2ee4c7edbda832bd14200))
- **routes:** Use custom checkboxes on characters index ([b16fb0c](https://github.com/TenkoSpirit/genshin.zenless.club/commit/b16fb0c23ffe55d88d348107f6a585588d0ec11c))
- **routes:** Charater info page now utilizes nested routes so it's easier to split the data ([d79326f](https://github.com/TenkoSpirit/genshin.zenless.club/commit/d79326fb36dda0962f11987690690ffd1b992d63))
- **routes:** Removed character overview route and turned it into index ([e75105c](https://github.com/TenkoSpirit/genshin.zenless.club/commit/e75105cede9611b37283ae875c166897a27f4068))
- **routes:** Character creation route :o ([0343891](https://github.com/TenkoSpirit/genshin.zenless.club/commit/0343891041560cdad51014c950338d3223561356))
- **routes:** Added file uploader ([4f43e91](https://github.com/TenkoSpirit/genshin.zenless.club/commit/4f43e918db7e3405f06986724c4cd79a414a7cf1))
- **routes:** File manager ([1c4b92e](https://github.com/TenkoSpirit/genshin.zenless.club/commit/1c4b92e81085a27c381511c3f651785967c61d5d))
- **routes:** Sort uploaded s3 objects by date by default ([e8c396a](https://github.com/TenkoSpirit/genshin.zenless.club/commit/e8c396a0445ee45179d3e5d973e99fd4454b5de6))
- **routes:** Sync character page with model changes ([fc46b2a](https://github.com/TenkoSpirit/genshin.zenless.club/commit/fc46b2ae901b95b07748c782c042b824ee55d0f4))
- **routes:** Character page gacha icon will now consider S3 first ([380e5c8](https://github.com/TenkoSpirit/genshin.zenless.club/commit/380e5c88209b96bc8f7c38c4226b2b694b269dd4))
- **routes:** Added tags input field and back to file manager link ([0da1dde](https://github.com/TenkoSpirit/genshin.zenless.club/commit/0da1dde38aa655fce67d6d093a4a2807ca7830d0))
- **routes:** Using uploaded files data from db isntead of fetching s3 objects ([9364756](https://github.com/TenkoSpirit/genshin.zenless.club/commit/93647569e7b59240c071ba5ebfcf131146b5b0c5))
- **routes:** Updated file manager so it's possible to delete files ([a991172](https://github.com/TenkoSpirit/genshin.zenless.club/commit/a9911727f136e606d38c801ce1c2cf31716cfc57))
- **routes:** More granular effect conditions for seletcted files atom reset ([46fcfb8](https://github.com/TenkoSpirit/genshin.zenless.club/commit/46fcfb8a1f9059adfc5676519a9fe60ff993b73e))
- **routes:** Prevent file reuploads via file integrity checks ([541cebb](https://github.com/TenkoSpirit/genshin.zenless.club/commit/541cebb277dc50f3abf97d74006f43ed410891de))
- **routes:** Added a way to change users passwords in admin view ([2b92c60](https://github.com/TenkoSpirit/genshin.zenless.club/commit/2b92c60eff2a3cf77dfcd8bb03889fe4a94b14a8))
- **routes:** Excluded sensitive routes from indexing ([e56e930](https://github.com/TenkoSpirit/genshin.zenless.club/commit/e56e93062f06dde748ac9768c09439398dba2bcf))
- **routes:** File upload action return data is a bit different now, also switched to inference for `useActionData` ([b5a1c16](https://github.com/TenkoSpirit/genshin.zenless.club/commit/b5a1c16430af8f55376f882fdd3f7e6dba1e6818))
- **routes:** Characters provide list of characters ordered by ids ([4498e47](https://github.com/TenkoSpirit/genshin.zenless.club/commit/4498e4746edb622f1aa84d3d8f9412cddc9b1b9a))
- **routes:** Add translations to character tabs ([0319d80](https://github.com/TenkoSpirit/genshin.zenless.club/commit/0319d8093d214268b153b4fcc04651a6b4fbf2de))
- **routes:** Added a bit of information to character overview ([40c0f71](https://github.com/TenkoSpirit/genshin.zenless.club/commit/40c0f71281c80a0b4ec48d0386fd46d94f5559cb))
- **routes, schemas:** Posts schemas are now server only ([6e802e3](https://github.com/TenkoSpirit/genshin.zenless.club/commit/6e802e305f8589dccb675b89a13a1a2955ab709b))
- **routes, schemas:** Require image urls instead of blobs on character creation page ([40c12f1](https://github.com/TenkoSpirit/genshin.zenless.club/commit/40c12f13b318a43d2f8e2f37b383c621915d7578))
- **schemas:** User roles array validator ([d9f4645](https://github.com/TenkoSpirit/genshin.zenless.club/commit/d9f4645fa935edaf708043004fb81fb40231c10d))
- **schemas:** Added validator for array of permission flags ([dab2f22](https://github.com/TenkoSpirit/genshin.zenless.club/commit/dab2f22c3fb30079af46009abc80fb0b415353e2))
- **schemas:** Added a character creation schema ([a7d9288](https://github.com/TenkoSpirit/genshin.zenless.club/commit/a7d92884c24814ed69cd758f47f4224e9e9431f7))
- **schemas:** Added `FileUpload` and `AllowedMimeTypes` ([d0067fb](https://github.com/TenkoSpirit/genshin.zenless.club/commit/d0067fb271a6602db6bc763b6bbdada60ba38c6d))
- **schemas:** Created `UInstNumericString` validator ([2b768da](https://github.com/TenkoSpirit/genshin.zenless.club/commit/2b768da9a3f680b8818ff5694582e16b8b4f5590))
- **schemas:** Added `tags` to `FileUpload` schema ([f14f85e](https://github.com/TenkoSpirit/genshin.zenless.club/commit/f14f85ed2dc153f04bddc9ad034e033ef72b4b49))
- **server:** Updated caching rules ([a388913](https://github.com/TenkoSpirit/genshin.zenless.club/commit/a3889139822e58f9c842901b7c68d2d3871b394f))
- **tailwind:** Overriden gray color with custom values ([25820cf](https://github.com/TenkoSpirit/genshin.zenless.club/commit/25820cf822e638c7dc9ce1d3029a50fcf625b83d))
- **tailwind:** Removed custom gray ([48dc244](https://github.com/TenkoSpirit/genshin.zenless.club/commit/48dc244026fd1ca20d04a86d3a8267a05c50e870))
- **tailwind:** Added "blau" color ([3feae62](https://github.com/TenkoSpirit/genshin.zenless.club/commit/3feae629dbf8825001b01a9f27e7a01c7485fb5d))
- **tailwind:** Include "blau" in extended theme ([47a9300](https://github.com/TenkoSpirit/genshin.zenless.club/commit/47a9300e7750b2e075f9e35c3b8928c88a849f11))
- **tailwind:** Set blau as primary ([faf98c3](https://github.com/TenkoSpirit/genshin.zenless.club/commit/faf98c39d20e445a1df38d13cadeee63581e132c))
- **tailwind:** Switch to open colors (inspired by Mantine) ([9c76edc](https://github.com/TenkoSpirit/genshin.zenless.club/commit/9c76edcf6049ca3f97c37451349a54084a8d1c5e))
- **tailwind:** Added one more screen breakpoint ([7e2bd94](https://github.com/TenkoSpirit/genshin.zenless.club/commit/7e2bd94d3c52c7682fb47e5afb599a8444478b08))
- **types:** Added custom `RouteHandle` type ([9a9016d](https://github.com/TenkoSpirit/genshin.zenless.club/commit/9a9016da45dc2ae5ee719404c821a5d27790489f))
- **types:** Added `PolymorhpicProps` generic ([c07d4bb](https://github.com/TenkoSpirit/genshin.zenless.club/commit/c07d4bb94640ba5e4b7bd7e5eabb9cb712b09cc4))
- **types:** Created a `MaybePromise<T>` which is a union of provided type and a promisified provided type ([e4d2260](https://github.com/TenkoSpirit/genshin.zenless.club/commit/e4d22608e396314d1e994b3311ccc606caf3028c))
- **utils:** Added server only helper `requiredServerEnv` ([5cc2bd3](https://github.com/TenkoSpirit/genshin.zenless.club/commit/5cc2bd3cc726b5a489f89210c4bb1afdae7a9e5b))
- **utils:** Moved `oauth` module to `utils` ([28fe4ac](https://github.com/TenkoSpirit/genshin.zenless.club/commit/28fe4ac50eed1728eee70071235d6cce04f0d056))
- **utils:** Added `hasAccess` and `userHasAccess` which perform permission flags checks ([2d3ad98](https://github.com/TenkoSpirit/genshin.zenless.club/commit/2d3ad98882281b4957ec2392704500c6df8c50f4))
- **utils:** Updated post permission check functions with flags ([9fc6545](https://github.com/TenkoSpirit/genshin.zenless.club/commit/9fc6545fc18a9014dccaa8d030a2c238c669c82e))
- **utils:** Upgraded `permissions` utilities with new `validatePermissions` ([8a386ce](https://github.com/TenkoSpirit/genshin.zenless.club/commit/8a386cefdd0b4253868e5db87f63ad43b9c192aa))
- **utils:** A custom rehype plugin that makes all images lazy and async ([794d2b5](https://github.com/TenkoSpirit/genshin.zenless.club/commit/794d2b5ffb016c1871106c84dbd55f111f575019))
- **utils:** Updated predefined responses with a bunch of new functions and types ([0cf00c8](https://github.com/TenkoSpirit/genshin.zenless.club/commit/0cf00c8232d12ba144e2547e06a2562f49cd436f))
- **utils:** Updated types for thrown errors and exported a type to use with `useCatch` ([7195ff5](https://github.com/TenkoSpirit/genshin.zenless.club/commit/7195ff5bbf749d603cc8a6e6a1d2521cdee8b3ce))
- **utils:** Updated Discord OAuth functions with predefined responses ([de8a784](https://github.com/TenkoSpirit/genshin.zenless.club/commit/de8a784df27eb7c982c2555ebfaa99e7afff5bd0))
- **utils:** Updated sessions error responses with predfiened ones ([4d2dba0](https://github.com/TenkoSpirit/genshin.zenless.club/commit/4d2dba037b478968b384c3ae88dd2281a2f9fbac))
- **utils:** Added `details` property to `TypedErrorResponse` ([e2b1afb](https://github.com/TenkoSpirit/genshin.zenless.club/commit/e2b1afb456444f9c29a59e642d5bf97b7279e4ab))
- **utils:** Instead of checking if user's account disabled in `getUser` do that in `ensureAuthorizedUser` ([9dc4ba1](https://github.com/TenkoSpirit/genshin.zenless.club/commit/9dc4ba1788f58c9f23dec96c50647549994c07a3))
- **utils:** Instead of throwing json error redirect to `/me/account-disabled` ([29cddb9](https://github.com/TenkoSpirit/genshin.zenless.club/commit/29cddb9b21afecaded2d0870d74f5af21c694c02))
- **utils:** Added `color-scheme` cookie with some functions related to to it ([a193316](https://github.com/TenkoSpirit/genshin.zenless.club/commit/a193316125fc6446377b329b7cde33f3cc2940fc))
- **utils:** Removed `system` from supported color schemes ([494f165](https://github.com/TenkoSpirit/genshin.zenless.club/commit/494f16579d96533640d5c3fdd199c166fc198cf1))
- **utils:** Added image manipulation utils ([748e23d](https://github.com/TenkoSpirit/genshin.zenless.club/commit/748e23d6c223bde32da77b7332bd60b41f345891))
- **utils:** Added S3 client and upload to bucket function ([67fc1d1](https://github.com/TenkoSpirit/genshin.zenless.club/commit/67fc1d19093640563cd8c2838c559c2628c6a340))
- **utils:** Added `noindex` to meta generator ([abb5cd7](https://github.com/TenkoSpirit/genshin.zenless.club/commit/abb5cd7ac8ce1e99c7f08556c4c6970fc53901b5))
- **utils/s3:** Exported `S3_DOMAIN` and updated uploader for users ([a7569a1](https://github.com/TenkoSpirit/genshin.zenless.club/commit/a7569a10a67358bc5bf364e4e5959e15ca39a1c8))
- **utils/s3:** Added `deleteFromBucket` ([80acfb6](https://github.com/TenkoSpirit/genshin.zenless.club/commit/80acfb6ce64af706c00c476aec64cba66cacdce5))
- **utils/s3:** Require SHA256 checksums on file user file upload ([55e6e52](https://github.com/TenkoSpirit/genshin.zenless.club/commit/55e6e522514b2eb38be83539d7943a50e1d8189a))
- **utils/session:** Throw on disabled accounts and do that in `getAuthenticatedUser` instead ([dfbb27f](https://github.com/TenkoSpirit/genshin.zenless.club/commit/dfbb27f2e2e6f0a224ef5487df99d6c14e2d6703))
- **utils/session:** Better type for a `predicate` parameter on `getAuthorizedUser` ([1483f56](https://github.com/TenkoSpirit/genshin.zenless.club/commit/1483f562057d06b0652c7515e5c5f635f7d85f81))
- **utis:** Added `isNil` ([1e968bc](https://github.com/TenkoSpirit/genshin.zenless.club/commit/1e968bcbd0a46a59a5fe3271cbf759d3b5f0cecd))
- **No category:** Rewrite to Remix.js ([b75abb3](https://github.com/TenkoSpirit/genshin.zenless.club/commit/b75abb368b29b3f68e1f305b5b0e66254f1e0d22))
- **No category:** Discord OAuth module ([e8cdb3a](https://github.com/TenkoSpirit/genshin.zenless.club/commit/e8cdb3adbf25be0ff722490392ece4712225fe3f))
- **No category:** Switch to PostCSS from Tailwind CLI ([88893ed](https://github.com/TenkoSpirit/genshin.zenless.club/commit/88893eddd6e48c15b889343c8b0c7a2905870866))
- **No category:** Include Inter font and use it's variable version ([f28cf7d](https://github.com/TenkoSpirit/genshin.zenless.club/commit/f28cf7d1816a51014ae62a9dab8a49daaedd2bc0))
- **No category:** Updated `.env.example` ([3d04ac2](https://github.com/TenkoSpirit/genshin.zenless.club/commit/3d04ac25c819501af932d30e073adf4f5f884454))
- **No category:** Require latest node 18 ([4324c6d](https://github.com/TenkoSpirit/genshin.zenless.club/commit/4324c6d39049c0d3b929caed05684629ab8bc86c))
- **No category:** Replace old domain with new one ([5f48908](https://github.com/TenkoSpirit/genshin.zenless.club/commit/5f48908d2dd52a249311d140831cd83ac46ea528))

### Miscellaneous Tasks

- **deps:** Bumped `tailwindcss` and `eslint` ([76b27a9](https://github.com/TenkoSpirit/genshin.zenless.club/commit/76b27a9d6f19952d013455a0ff19f94eb4b731d9))
- **deps:** Rehype plugins ([354d657](https://github.com/TenkoSpirit/genshin.zenless.club/commit/354d657adcc8bb4410c13a059d1f526b90fa69d4))
- **deps:** Managing dependencies, some updated and removals ([505abf0](https://github.com/TenkoSpirit/genshin.zenless.club/commit/505abf037ef427da5012007b28d05bd5e643d739))
- **deps:** Upgraded dependencies ([3d4f984](https://github.com/TenkoSpirit/genshin.zenless.club/commit/3d4f9843defc242cc6aba88307309d6a71fef2fb))
- **deps:** Bump typescript ([aadb82d](https://github.com/TenkoSpirit/genshin.zenless.club/commit/aadb82d773130093a6c12010cbfa106d51f6c410))
- **deps:** Upgraded dependencies ([81bd83d](https://github.com/TenkoSpirit/genshin.zenless.club/commit/81bd83d9260652a27f0697b6184198ad73920109))
- **deps:** Resolution for a vulnerable package and updated packages ([673c04b](https://github.com/TenkoSpirit/genshin.zenless.club/commit/673c04b0ff3ae3eb1911d71cc876136b7fd8238a))
- **deps:** Typescript 4.9 rc ([6ff74b1](https://github.com/TenkoSpirit/genshin.zenless.club/commit/6ff74b1a1bf2d43cb47b2e6c29ce45e2e832d47b))
- **deps:** Added aws sdk and sharp ([178aa1e](https://github.com/TenkoSpirit/genshin.zenless.club/commit/178aa1eb7847e7ac83653a72d1156cd5f337ca5e))
- **deps:** Added `nanoid` ([6742f48](https://github.com/TenkoSpirit/genshin.zenless.club/commit/6742f489d859dd550cbd16ad565aa263fa8f09fd))
- **deps:** Version bumps ([363b2e8](https://github.com/TenkoSpirit/genshin.zenless.club/commit/363b2e8519bf91b276926f642ab42b33186f0da5))
- **deps:** Bumped versions and added formatjs ([9f13832](https://github.com/TenkoSpirit/genshin.zenless.club/commit/9f1383261c073654046df277e93ecf4767cb2202))
- **deps:** Bumped some dependencies ([b7598aa](https://github.com/TenkoSpirit/genshin.zenless.club/commit/b7598aac4346687acc2be1ac1a6ff06021247c8f))
- **rotues:** Removed `/me/account-disabled` ([31fd644](https://github.com/TenkoSpirit/genshin.zenless.club/commit/31fd64420c8f14abaa1bcaf4444684851eb121ba))
- **No category:** Switch to Mozilla Public License 2.0 ([1d4be54](https://github.com/TenkoSpirit/genshin.zenless.club/commit/1d4be549c42538020dd7f66e9d261e89b71be8b2))
- **No category:** Updated readme ([4a3d8b5](https://github.com/TenkoSpirit/genshin.zenless.club/commit/4a3d8b5dc29db94da7c3071367ab3dd296df9981))

### Refactor

- **components:** Updated generics for `Paper` ([0ffc6b8](https://github.com/TenkoSpirit/genshin.zenless.club/commit/0ffc6b8eeef0b3e6ded2ec8c0ebb9dbd72b0a257))
- **models:** Removed "jsonSafe" getter since remix can do that on it's own ([405bbf2](https://github.com/TenkoSpirit/genshin.zenless.club/commit/405bbf269bb0206ccff4cdfee0ff478141f4044c))
- **routes:** Removed some dead code from yashiro user slug route ([d41ff39](https://github.com/TenkoSpirit/genshin.zenless.club/commit/d41ff39dbd0195868eb0e3c8d853be78836fe63b))
- **utils, routes:** Renamed `ensureAuthenticatedUser` to `getAuthenticatedUser` ([4cab287](https://github.com/TenkoSpirit/genshin.zenless.club/commit/4cab287654826a4ebf02d625351c8f4908cd56f5))
- **utils, routes:** Renamed `ensureAuthorizedUser` to `getAuthorizedUser` ([3762850](https://github.com/TenkoSpirit/genshin.zenless.club/commit/376285030cdf1cdf658e87369a5dda2b726199ab))
- **utils/s3:** Removed redundant import ([f33850a](https://github.com/TenkoSpirit/genshin.zenless.club/commit/f33850a7b169f39d216729713ee857c3e5f0334e))
- **utils/session:** Removed commented out code ([c76670f](https://github.com/TenkoSpirit/genshin.zenless.club/commit/c76670fbc8ef4cc93d0f0f50984e114fb8b896db))
- **No category:** Renamed `getAuthenticatedUser` to `requireUser` ([9b8cdc5](https://github.com/TenkoSpirit/genshin.zenless.club/commit/9b8cdc57cb2c54a6f5f9a28964e7b7ecb54d9cd8))
- **No category:** Renamed `getAuthorizedUser` to `authorizeUser` ([aac6178](https://github.com/TenkoSpirit/genshin.zenless.club/commit/aac6178cf137459d611b2cf495d4a0048d4ce027))
