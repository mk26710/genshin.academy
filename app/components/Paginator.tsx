...
export const Paginator: FunctionComponent<PaginatorProps> = ({ page, totalPages }) => {
  ...
  return (
    <div className="flex flex-row items-center justify-center gap-1">
      <button onClick={handlePageFirst} className="w-fit p-1.5">
        <ChevronDoubleLeftIcon className="h-5 w-5" />
      </button>

      <button onClick={handlePageDecrement} className="w-fit p-1.5">
      ...
      <button onClick={handlePageIncrement} className="w-fit p-1.5">
        <ChevronRightIcon className="h-5 w-5" />
      </button>

      <button onClick={handlePageLast} className="w-fit p-1.5">
