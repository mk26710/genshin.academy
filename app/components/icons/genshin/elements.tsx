...
export const AnemoIcon: FC<ElementIconProps> = ({
  ...
  return (
    <svg xmlns={xmlns} viewBox={viewBox} {...props}>
      <g id="bb78dea4-93c4-4ee1-aa56-dab699523de1" data-name="Layer 2">
        <g id="a282dd6a-736a-4628-a573-e433f59aa349" data-name="Elements">
          <g id="b39a00df-9117-4d2b-b241-c6e92e7afe14" data-name="Ameno">
            <path
...
export const CryoIcon: FC<ElementIconProps> = ({
  ...
  return (
    <svg xmlns={xmlns} viewBox={viewBox} {...props}>
      <g id="fe2860c6-76aa-4069-a7e6-78813d1777f4" data-name="Layer 2">
        <g id="ac30c436-2641-45d2-aadc-21bb0491d156" data-name="Elements">
          <g id="b703f8e9-2afc-433f-b236-e583d0ba03bb" data-name="Cryo">
            <path
...
export const ElectroIcon: FC<ElementIconProps> = ({
  ...
  return (
    <svg xmlns={xmlns} viewBox={viewBox} {...props}>
      <g id="fb1f46c8-b977-4d9e-9076-e7b5579e8c64" data-name="Layer 2">
        <g id="a5169da5-e4a0-4c84-aa54-23fd625c0edc" data-name="Elements">
          <g id="e68c1866-13fd-456d-ba35-65444d78827b" data-name="Electro">
            <path
...
export const GeoIcon: FC<ElementIconProps> = ({
  xmlns = "http://www.w3.org/2000/svg",
  viewBox = "0 0 14 14",
  ...props
}) => {
  return (
    <svg xmlns={xmlns} viewBox={viewBox} {...props}>
      <g id="ad33afc3-135b-4fd4-8e22-5c8b89d9906e" data-name="Layer 2">
        <g id="b035ee49-cb40-4eee-bc55-d3fe42c2667c" data-name="Elements">
          <g id="abc13f42-f912-4f64-bd7d-64eb3da7bf9e" data-name="Geo">
            <path
...
export const HydroIcon: FC<ElementIconProps> = ({
  ...
  return (
    <svg xmlns={xmlns} viewBox={viewBox} {...props}>
      <g id="aca62753-40b3-4342-a7ee-b09055e0ac8f" data-name="Layer 2">
        <g id="b1b59f35-7321-40a1-8b91-df13a0de40a1" data-name="Elements">
          <g id="baf48ff5-61e4-48be-8ee0-05d2bb162f3c" data-name="Hydro">
            <path
...
export const PyroIcon: FC<ElementIconProps> = ({
  xmlns = "http://www.w3.org/2000/svg",
  viewBox = "0 0 14 14",
  ...props
}) => {
  return (
    <svg xmlns={xmlns} viewBox={viewBox} {...props}>
      <g id="e6229a34-eb42-472e-a7ec-3d59ca539ebe" data-name="Layer 2">
        <g id="a1424b57-781d-436d-b592-afb7bbc902a4" data-name="Elements">
          <g id="ea4a7863-6beb-44d0-bd1b-85d5981d74a5" data-name="Pyro">
            <path
